...
// remember to add the #include ABOVE LATER WHEN ORGANIZING.
// DONT MAKE THE SAME MISTAKE AS THE frag glsl
...
vec3 lightingCalculations(vec3 albedo,vec3 tangent, vec3 normalWorldSpace, vec3 worldGeoNormal, vec3 skyLight,vec3 fragFeetPlayerSpace,vec3 fragWorldSpace) {
    ...
    // CREDITS TO "Samuel Gerkin" For helping me organize my shaders and helping me fix my old bugs and issues.
}